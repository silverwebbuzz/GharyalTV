...
function run(process, cliBinDir) {
    ...
    program
        ...
        return create_1.createCommand(config, directory, name, id);
    });
    program
        ...
        return init_1.initCommand(config, appName, appId, cmd.webDir);
    });
    program
        .command('serve')
    ...
    program
        ...
        .action(platform => {
        return sync_1.syncCommand(config, platform);
    });
    program
        .command('update [platform]')
        .description(`updates the native plugins and dependencies based in package.json`)
        .action(platform => {
        return update_1.updateCommand(config, platform);
    });
    program
